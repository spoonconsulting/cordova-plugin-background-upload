cordova.define("cordova-plugin-background-upload.FileTransferBackgroundProxy", function(require, exports, module) { module.exports = {
  startUpload: function (successCb, errorCb, params) {
    ...
    var request = window.superagent;//require('./superagent.js')
    request
      .post('https://api.cloudinary.com/v1_1/tyets/upload')
